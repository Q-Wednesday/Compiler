...
int main()
{
    char buf[128];
    char ops_stack[128];
    char vector[128]; //0 - num
    int assistant_vector[128];
    int RPN_stack[128];
    ...
    while (buf[i])
    {
        ...
        else
        {
            ...
            //         if (buf[i] == ')')
            //         {
            //             while (ops_stack_size!=0 && ops_stack[ops_stack_size - 1] != '(')
            //             {
            //                 ops_stack_size = ops_stack_size - 1;
            ...
            //         else
            //         {
            //             while (ops_stack_size!=0 && cmp_priority(ops_stack[ops_stack_size - 1], buf[i]))
            //             {
            //                 ops_stack_size = ops_stack_size - 1;
            //                 vector[vector_size] = ops_stack[ops_stack_size];
            //                 vector_size = vector_size + 1;
